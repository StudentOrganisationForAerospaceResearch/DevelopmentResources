ifdef::env-github[]
:imagesdir: https://github.com/StudentOrganisationForAerospaceResearch/DevelopmentResources/tree/garnettanner/stm32-example/STM32Resources/BuildEnvironment_Setup/images
endif::[]
