...
To flash the board use `st-flash write /path/to/project/build/<project>.bin 0x8000000`. Some difficulties may arise in this stage for Fedora, like the system giving `st-flash command not found` error. To solve this issue, try:
