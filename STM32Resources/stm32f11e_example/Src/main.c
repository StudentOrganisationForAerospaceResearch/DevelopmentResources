...
void blinkLightsTask(void const* argument)
{
    ...
    while (1)
    {
        ...
        HAL_GPIO_WritePin(LD4_GPIO_Port, LD4_Pin, counter & 0x1);
        HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, (counter >> 1) & 0x1);
        HAL_GPIO_WritePin(LD5_GPIO_Port, LD5_Pin, (counter >> 2) & 0x1);
        HAL_GPIO_WritePin(LD6_GPIO_Port, LD6_Pin, (counter >> 3) & 0x1);
        */
    }
}
